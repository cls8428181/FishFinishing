...
typedef void (^ChooseAddressSuccessBlock)(NSString *city,NSString *area,NSString *name,NSString *address,CGFloat latitude,CGFloat longitude,NSString *phone,UIImage *img);
