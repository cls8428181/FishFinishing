...
@interface MPBaseTableViewController ()<XHRefreshControlDelegate,UITableViewDelegate,UITableViewDataSource> {
...
- (void)setUpTableFootViewWithTitle:(NSString *)titlestr andFootViewH:(CGFloat)height
{
    ...
    self.knbTableView.tableFooterView = contentLabel;
}
...
- (void)setFootHidden:(BOOL)hidden{
    self.knbTableView.mj_footer.hidden = hidden;
}
