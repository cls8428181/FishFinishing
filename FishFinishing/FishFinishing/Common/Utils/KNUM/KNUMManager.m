...
#import "ShareView.h"
// 友盟AppKey
#define KN_UMAppKey @"56e61fa967e58edd97000c3b"

#define KN_WeixinAppId @"wxfd961ca17ae513c5"
#define KN_WeixinAppSecret @"0a089b9cfcddd448772263b78e1bd13c"
#define KN_WeiboAppId @"3547299987"
#define KN_WeiboAppSecret @"609e2e4c0801e6233f85056059f3b4c2"
#define KN_QQAppId @"1105450448"
...
- (void)configuraUM {
    ...
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_QQ appKey:KN_QQAppId appSecret:KN_QQAppSecret redirectURL:@"http://mobile.umeng.com/social"];

    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Sina appKey:KN_WeiboAppId appSecret:KN_WeiboAppSecret redirectURL:@"http://sns.whalecloud.com/sina2/callback"];
    ...
    [[UMSocialManager defaultManager] shareToPlatform:platformType
                                ...
                                currentViewController:controller
                                           completion:^(id data, NSError *error) {
                                               if (error) {
                                                   if (transmit) {
                                                       [LCProgressHUD showMessage:@"转发取消!"];
                                                   } else {
                                                       [LCProgressHUD showMessage:@"分享取消!"];
                                                   }
                                               } else {
                                                   if (transmit) {
                                                       [LCProgressHUD showMessage:@"转发成功!"];
                                                   } else {
