//
//  KNBHomeCompanyCityViewController.m
//  FishFinishing
//
...
@interface KNBHomeCompanyCityViewController ()<FMTagsViewDelegate>
//标签视图
...
@implementation KNBHomeCompanyCityViewController
...
- (void)tagsView:(FMTagsView *)tagsView didSelectTagAtIndex:(NSUInteger)index {
    ...
    NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:selectString,@"text", @"1",@"index", nil];
    NSNotification *notification = [NSNotification notificationWithName:NSStringFromClass([KNBHomeCompanyCityViewController class]) object:nil userInfo:dict];
