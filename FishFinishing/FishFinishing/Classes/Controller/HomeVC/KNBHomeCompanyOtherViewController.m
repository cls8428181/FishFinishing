//
//  KNBHomeCompanyOtherViewController.m
//  FishFinishing
//
...
@interface KNBHomeCompanyOtherViewController ()<FMTagsViewDelegate>
//标签视图
...
@implementation KNBHomeCompanyOtherViewController
...
- (void)fetchData {
    self.dataArray = @[@"预约次数",@"案例数量"].mutableCopy;
...
//    }
    NSDictionary *dict = [NSDictionary dictionaryWithObjectsAndKeys:selectString,@"text", @"2",@"index", nil];
    NSNotification *notification = [NSNotification notificationWithName:NSStringFromClass([KNBHomeCompanyOtherViewController class]) object:nil userInfo:dict];
